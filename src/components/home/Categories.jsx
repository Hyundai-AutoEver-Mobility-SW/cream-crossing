...
const Gategories = () => {
  ...
  const categories = [
    ...
    { title: '주말 핫딜', imageSrc: 'https://i.pinimg.com/736x/fc/b1/08/fcb108ad28642c7bf15c36f1f240413e.jpg' },
    {
      title: '신상',
      imageSrc:
        'https://img.redbull.com/images/c_fill,g_auto,w_450,h_600/q_auto:low,f_auto/redbullcom/2020/1/14/iyhcnzif9tdofay3v19z/dong',
    },
    {
      title: '든든한 야외 필수템',
      imageSrc:
        'https://img.redbull.com/images/c_fill,g_auto,w_450,h_600/q_auto:low,f_auto/redbullcom/2021/10/21/u9aojqkazx4laj2bucrz/sdf',
    },
    {
      title: '함께 해요',
      imageSrc: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSu4t1nTalbi31hXyR2j6Mpb8Ekgz95nNdSYw&s',
    },
    { title: '가성비 GOOD', imageSrc: 'https://cdn.gamemeca.com/data_center/210/732/20200325120307.jpg' },
    {
      title: '스터디윗미',
      imageSrc: 'https://img.redbull.com/images/q_auto,f_auto/redbullcom/2021/10/21/rqcb5zz3021ft5usgi2f/dsf',
    },
    {
      title: '뮤직 추천',
      imageSrc:
        'https://play-lh.googleusercontent.com/rzRzYiJO6CxCSCxmE6fq2uBeSR_TBYYIWWRQcnSoHxCj7tG7VAkoqaWHJPw3tg0A1YwQ=w526-h296-rw',
    },
    {
      title: '오늘의 대어?',
      imageSrc: 'https://cloudfront-ap-northeast-1.images.arcpublishing.com/chosun/GPWWHGL2FEX6CABSCO36ZM2N3I.jpg',
    },
    {
      title: '바다 속 작은 모험',
      imageSrc: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTe2pQrifO6lf18ZPquEcgBW38TDEkcNmZ0HA&s',
    },
    ...
    { title: '불멍 아이템', imageSrc: 'https://newsimg.sedaily.com/2020/05/08/1Z2O72CP0G_7.jpg' },
    {
      title: '주인공은 누구',
      imageSrc:
        'https://t3.daumcdn.net/thumb/R720x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/8fXh/image/vOi1mNqKtW6_B3HlBqgsdUa9jUk.jpg',
    },
            ...
            <LazyLoad key={index} height={100} offset={100} once>
              <div className="relative p-2">
                <div className="flex flex-col items-center">
                  ...
                  {!isLoaded && <div className="w-36 h-32 bg-gray-300 animate-pulse rounded-md mb-2"></div>}
